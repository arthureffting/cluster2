...
from scripts.models.hw.grid_distortion import warp_image
from scripts.utils import safe_load, augmentation, string_utils
...
def collate(batch):
    ...
    all_labels = np.empty((len(batch), dim1)).astype(np.int32)
    label_lengths = []
